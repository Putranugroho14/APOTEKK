        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-8">
            {loading ? (
              ...
              filtered.map(obat => (
                <div key={obat.id} className="group glass-card-dark rounded-[24px] md:rounded-[40px] p-4 md:p-6 border border-white/10 shadow-sm transition-all duration-500 hover:-translate-y-2 flex flex-col animate-fade-in">
                  ...
                  <div className="flex-1 flex flex-col">
                    <h4 className="font-black text-white text-sm md:text-xl mb-2 md:mb-3 line-clamp-1 group-hover:text-cyan-400 transition-colors cursor-pointer" onClick={() => setSelectedProduct(obat)}>{obat.nama_obat}</h4>
                    ...
                    <div className="flex items-center justify-between pt-3 md:pt-6 border-t border-white/5 mt-auto">
                      <div className="relative pl-3 md:pl-5 border-l-2 md:border-l-4 border-cyan-500 py-0.5">
                        <p className="text-[7px] md:text-[10px] font-black text-slate-500 uppercase tracking-widest mb-0.5 md:mb-1">HARGA TERBAIK</p>
