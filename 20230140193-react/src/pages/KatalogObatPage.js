              ...
              filtered.map(obat => (
                <div key={obat.id} className="group glass-card-dark rounded-[24px] md:rounded-[40px] p-3 md:p-6 border border-white/10 shadow-sm transition-all duration-500 hover:-translate-y-2 flex flex-col animate-fade-in">
                  ...
                  <div className="flex-1 flex flex-col">
                    <h4 className="font-black text-white text-xs md:text-lg mb-2 md:mb-3 line-clamp-1 group-hover:text-cyan-400 transition-colors cursor-pointer" onClick={() => setSelectedProduct(obat)}>{obat.nama_obat}</h4>
