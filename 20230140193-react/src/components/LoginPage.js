      ...
      <div className="relative z-10 w-full max-w-lg p-6 animate-fade-in">
        <div className="glass-card-dark p-10 md:p-16 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] border border-white/10">
          ...
          <div className="text-center mb-12">
            <div className="inline-block p-4 bg-white rounded-[28px] shadow-xl mb-8 border border-slate-100 hover-lift">
              <img
                src={LOGO_URL}
                alt="Logo Apotek"
            ...
            <h2 className="text-4xl font-black text-slate-900 tracking-tighter mb-4">Admin <span className="text-cyan-500">Portal</span></h2>
            <p className="text-slate-500 font-bold tracking-wide">Silakan masuk untuk mengelola apotek.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-8">
            <div className="space-y-3">
              ...
              <div className="group relative">
                ...
                <input
                  ...
                  className="w-full pl-16 pr-8 py-5 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-500 transition-all font-bold text-sm text-slate-900 placeholder:text-slate-400 focus:bg-white"
            ...
            <div className="space-y-3">
              ...
              <div className="group relative">
                ...
                <input
                  ...
                  className="w-full pl-16 pr-14 py-5 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-500 transition-all font-bold text-sm text-slate-900 placeholder:text-slate-400 focus:bg-white"
                  placeholder="••••••••"
                  autoComplete="current-password"
                />
                <button
                  type="button" onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-6 top-1/2 -translate-y-1/2 text-slate-400 hover:text-cyan-600 transition-colors"
                >
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-6 premium-gradient text-white font-black rounded-[24px] shadow-2xl shadow-cyan-900/10 hover:shadow-cyan-200 transition-all flex items-center justify-center gap-4 disabled:opacity-70 uppercase tracking-[0.3em] text-[11px] hover:-translate-y-1"
            >
              {isLoading ? (
          ...
          <div className="mt-12 pt-10 border-t border-slate-100 flex flex-col items-center gap-4">
            <button onClick={() => navigate('/')} className="text-[10px] font-black text-slate-400 hover:text-cyan-600 uppercase tracking-[0.2em] transition-colors">
